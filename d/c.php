            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white text-center py-3">
                        ...
                        <p class="mb-0 opacity-75">สุรีรัตน์ เกษกัน (เตย) - Gemini</p>
                    </div>
                ...
                <div class="alert alert-success mt-4 shadow-sm" role="alert">
                    <h4 class="alert-heading"><i class="bi bi-check-circle-fill"></i> ข้อมูลที่บันทึก:</h4>
                    <hr>
                    <div class="row">
                        <div class="col-md-6"><strong>ชื่อ-สกุล:</strong> <?php echo $fullname; ?></div>
                        <div class="col-md-6"><strong>เบอร์โทร:</strong> <?php echo $phone; ?></div>
                        <div class="col-md-6"><strong>ส่วนสูง:</strong> <?php echo $height; ?> ซม.</div>
                        <div class="col-md-6"><strong>วันเดือนปีเกิด:</strong> <?php echo $birthday; ?></div>
                        <div class="col-md-12 mt-2"><strong>สาขาวิชา:</strong> <?php echo $major; ?></div>
                        <div class="col-md-12 mt-2"><strong>ที่อยู่:</strong> <?php echo $address; ?></div>
                        <div class="col-md-12 mt-2">
                            <strong>สีที่ชอบ:</strong> 
                            <div class="color-preview mt-1" style="background-color:<?php echo $color; ?>; width: 100%; max-width: 300px;">
                                <?php echo $color; ?>
                            </div>
                        </div>
                    </div>
