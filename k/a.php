...
<body>
    ...
    <div class="info-box">
        <h1>งาน K</h1>
        <p><strong>66010914021</strong> [ใส่รหัสนิสิตของคุณ]</p>
        <p><strong>สุรีรัตน์ เกษกัน (เตย)</strong> [ใส่ชื่อ-นามสกุลของคุณ]</p>
    </div>

    <br>

    <button class="btn btn-student" onclick="showImage('images/3.jpg')">เปิดรูปตัวเอง</button>
